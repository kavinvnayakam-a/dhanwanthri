...
export const translations = {
  en: {
    ...
    contact: {
      ...
      loc: "Location",
      locVal: "Chennai, Tamil Nadu, India",
      viewMap: "View on Map",
      phone: "Phone",
      phoneVal: "+91 XXX XXX XXXX",
      phoneSub: "24/7 Availability",
      hours: "Clinic Hours",
      hoursVal: "7:00 AM — 9:00 PM",
      hoursSub: "Monday through Sunday",
      social: "Social Links",
      formTitle: "Book Appointment",
      formDesc: "Fill out the form below to request a consultation.",
      name: "Full Name",
  ...
  ta: {
    ...
    footer: {
      ...
      ctaBook: "உங்கள் வருகையை பதிவு செய்க",
