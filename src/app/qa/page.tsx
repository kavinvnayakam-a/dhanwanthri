...
export default function QAPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(error);
      setAnswer("I'm sorry, I encountered an error processing your request. Please try again later.");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const suggestedQuestions = [
    "How can kinesiology help with my back pain?",
    "What are the benefits of HBOT?",
    "What is the difference between dry needling and acupuncture?",
    "How does joint manipulation work?",
    "Who is Dr. Dharmesh Kubendiran?"
  ];
    ...
    <div className="min-h-screen bg-background py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="text-center mb-12 space-y-4">
          <Badge className="bg-accent text-accent-foreground mb-2">AI Assistant</Badge>
          <h1 className="text-4xl font-headline font-bold text-primary">Healing Insights Assistant</h1>
          <p className="text-lg text-foreground/60">
            Ask our AI about our treatments, specific conditions, or clinical methodology.
          </p>
        </header>
        ...
        <Card className="shadow-xl border-none overflow-hidden bg-white">
          <CardHeader className="bg-primary text-primary-foreground p-8">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="font-headline">Virtual Consultant</CardTitle>
            </div>
            <CardDescription className="text-primary-foreground/70">
              Get immediate answers based on our clinical expertise.
            </CardDescription>
          </CardHeader>
          <CardContent className="p-8 space-y-8">
            ...
            <div className="space-y-4">
              <p className="text-sm font-bold text-foreground/40 uppercase tracking-widest">Suggested Questions:</p>
              ...
              <div className="animate-in fade-in slide-in-from-top-4 duration-500 bg-accent/5 p-6 rounded-2xl border border-accent/20">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    <p className="font-bold text-primary">Our Insights:</p>
