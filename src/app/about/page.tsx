  ...
  return (
    <div className="min-h-screen bg-background py-8 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 lg:mb-16 space-y-4 text-center lg:text-left">
          <Badge className="bg-primary text-primary-foreground mb-2">{t.about.badge}</Badge>
          <h1 className="text-4xl md:text-6xl font-headline font-bold text-primary leading-tight">{t.about.name}</h1>
          <p className="text-xl md:text-2xl text-accent font-bold">{t.about.title}</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <div className="space-y-10">
            <div className="prose prose-lg text-foreground/70 space-y-8">
              ...
              <div className="pt-6">
                <h3 className="text-2xl font-headline font-bold text-primary mb-4 border-l-4 border-accent pl-4">{t.about.philosophy}</h3>
                <p className="italic bg-accent/5 p-6 rounded-2xl text-primary font-medium text-lg leading-relaxed shadow-inner">
                  {t.about.quote}
                </p>
              </div>

              <div className="bg-white p-8 md:p-10 rounded-3xl border border-primary/10 shadow-sm space-y-8">
                <h4 className="font-headline font-bold text-primary text-2xl">{t.about.expertiseTitle}</h4>
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base font-medium">
